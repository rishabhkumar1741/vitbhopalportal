...
export default function carpenter() {
    ...
    async function senduvdata(event) {
        ...
        const res = await fetch('http://localhost:3000/api/uv', option);
        ...
        <div>   <Navbar></Navbar>
            <div className="grid h-screen place-items-center ">
                <div className="shadow-2xl p-10 pt-2  srounded-2xl">
                    ...
                    <form className="w-full max-w-lg " onSubmit={senduvdata}>
                        <div className="flex flex-wrap -mx-3 mb-4">
                            <div className={`w-full md:w-1/2 px-3 mb-6 md:mb-0 `} >
                                <label className="block uppercase tracking-wide text-gray-700 text-xs font-bold mb-2" htmlFor="grid-first-name">
                                    First Name
                                </label>
                                <input onChange={fillform} name="fname" value={user ? user.name.FirstName : ""} className={`  appearance-none block w-full bg-gray-200 text-gray-700 border  rounded py-3 px-4 mb-3 leading-tight focus:outline-none focus:bg-white`} id="grid-first-name" type="text" placeholder="Jane" />
                            ...
                            <div className="w-full md:w-1/2 px-3">
                                ...
                                <input onChange={fillform} name="lname" value={user ? user.name.LastName : ""} className={`appearance-none block w-full bg-gray-200 text-gray-700 border border-gray-200 rounded py-3 px-4 leading-tight focus:outline-none focus:bg-white focus:border-gray-500`} id="grid-last-name" type="text" placeholder="Doe" />
                            </div>
                        </div>
                        <div className="flex flex-wrap -mx-3 mb-4">
                            <div className={`w-full md:w-1/2 px-3 mb-6 md:mb-0 `} >
