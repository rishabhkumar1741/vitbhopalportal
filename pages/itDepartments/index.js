...
export default function carpenter() {
  ...
  async function sendItDepartmentdata(event) {
    ...
    const res = await fetch("http://localhost:3000/api/itDepartment", option);
    ...
    <>
      ...
      <div className="grid h-screen place-items-center ">
        <div className="shadow-2xl p-10 pt-2  srounded-2xl">
          ...
          <form onSubmit={sendItDepartmentdata} className="w-full max-w-lg ">
              ...
              <div className="w-full md:w-3/3 px-3 mb-6 md:mb-0">
                ...
                <div className="relative">
                  <select
                    ...
                    onChange={fillform}
                    className={` disabled block appearance-none w-full bg-gray-200 border border-gray-200 text-gray-700 py-3 px-4 pr-8 rounded leading-tight focus:outline-none focus:bg-white focus:border-gray-500`}
                    id="grid-reason"
                  >
                    {funoption()}
                  </select>
            ...
            <div className="">
              <label className="block text-bold uppercase tracking-wide text-gray-700 text-xs font-bold mb-2 ">
                {" "}
                Description
              </label>
              <textarea
                onChange={fillform}
                name="desc"
                className="border border-solid border-gray-300 p-3 w-full rounded"
              />
            </div>
            <div className="flex justify-center items-center bg-blue-500 mt-4">
              <button
                className="p-2 text-white font-bold w-full "
                type="submit"
              >
                submit{" "}
              </button>
